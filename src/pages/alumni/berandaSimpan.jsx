  ...
  return (
    <>
      <div className="w-full bg-[#f8f9fa] min-h-screen">
        ...
        {/* --- HEADER SECTION --- */}
        <div className="relative pt-33 pb-16 md:pb-12 w-full z-10 shrink-0 overflow-hidden bg-gradient-to-br from-white via-[#f8f9fa] to-white">
          ...
          <div className="relative z-10 mt-2 max-w-7xl mx-auto px-6 lg:px-12">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-8 mb-12">
              ...
              >
                <div className="flex items-center gap-3 font-semibold mb-4 bg-primary/90 border border-primary/20 px-4 py-2 rounded-3xl backdrop-blur-sm shadow-lg">
                  {greeting.icon}
                  <span className="text-white text-sm md:text-base tracking-wide">{greeting.text}</span>
                </div>
                <h1 className="text-4xl md:text-5xl text-primary lg:text-[3.5rem] font-black tracking-tight uppercase leading-[1.1] mb-5 drop-shadow-md">
                  Halo, <span className="text-transparent bg-clip-text bg-third">{firstName}!</span>
                </h1>
                <p className="text-lg text-secondary md:text-lg font-medium max-w-md leading-relaxed mb-8">
                ...
                <div className="flex items-center gap-4 w-full justify-center lg:justify-start">
                  <button onClick={() => navigate('/alumni/profile')} className="px-6 py-3.5 bg-primary text-white hover:bg-primary/90 rounded-full text-sm font-black shadow-[0_8px_20px_rgba(60,87,89,0.3)] transition-all flex items-center gap-2 cursor-pointer hover:-translate-y-1">
                    <Users size={16} /> Update Profil
                  </button>
                  <button onClick={() => navigate('/alumni/lowongan')} className="px-6 py-3.5 bg-white hover:bg-slate-50 border border-slate-200 text-primary rounded-full text-sm font-bold shadow-lg transition-all flex items-center gap-2 cursor-pointer hover:-translate-y-1">
                    Cari Peluang <ArrowRight size={16} />
                  </button>
                </div>
              </motion.div>

              {/* --- BAGIAN KANAN: STUDY TRACER CONTEXTUAL CARDS --- */}
              <div className="hidden lg:flex relative z-10 w-full max-w-[450px] h-[320px] items-center justify-center">
                ...
                >
                  ...
                  <div className="relative z-10 flex justify-between items-start">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-500 text-xs font-medium">Tahun Lulus: 2023</p>
                      </div>
                    </div>
                    {isVerified ? (
                  ...
                  <div className="relative z-10 space-y-3">
                    ...
                    <div className="h-3 bg-slate-100 rounded-full overflow-hidden p-[2px] border border-slate-200">
                      <motion.div
                        initial={{ width: 0 }} animate={{ width: "75%" }} transition={{ delay: 0.8, duration: 1.2, ease: "easeOut" }}
                        className="h-full bg-gradient-to-r from-third to-white rounded-full relative"
                      >
                        <div className="absolute inset-0 bg-white/20 w-full h-full animate-[shimmer_2s_infinite]"></div>
                      </motion.div>
                    </div>
                    <p className="text-[10px] text-slate-400 italic font-medium">Selesaikan 2 bagian lagi untuk divalidasi sistem.</p>
                  </div>
                </motion.div>

                {/* 2. Statistik Gaji/Pekerjaan (Top Right) */}
                <motion.div
                ...
                >
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-sm font-black text-slate-800">82% Alumni</span>
                  </div>
                </motion.div>
