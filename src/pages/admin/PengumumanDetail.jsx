        ...
        <div className="bg-white rounded-4xl shadow-sm border border-slate-100 overflow-hidden">
          ...
          >
            ...
            <div className="absolute top-5 right-5 flex gap-2">
              ...
              <span className={`px-4 py-1.5 rounded-full text-[11px] font-bold uppercase tracking-wider shadow-lg backdrop-blur ${data.status === 'aktif' ? 'bg-green-500/90 text-white' :
