...
export default function YearsInput({
  ...
  return (
    <div className="space-y-1 w-full text-left relative" ref={dropdownRef}>
      {label && (
      ...
      {isOpen && (
        <div className="absolute z-50 w-full mt-1 bg-white border border-gray-100 rounded-lg shadow-xl overflow-hidden animate-in zoom-in-95 duration-200">
