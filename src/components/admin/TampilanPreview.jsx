    ...
    >
      ...
      >
          ...
          <div className='flex items-center gap-3'>
              ...
              <div>
                ...
                <p className='text-xs font-medium' style={{color: `${thirdColor}`}}>
                  Simulasi struktur asli Halaman Login, Landing Page, dan Modal.
                </p>
              </div>
          </div>
          <button 
        ...
        <div className="flex-1 overflow-y-auto p-5 md:p-8 space-y-12 bg-gray-100/50 custom-scrollbar">
          ...
          {/* ========================================================= */}
          {/* 2. PREVIEW LANDING PAGE (Scrollable) UTUH 100% */}
          {/* ========================================================= */}
          <div>
            <h4 className="text-sm font-bold text-gray-700 mb-3 flex items-center gap-2">
            ...
            <div className="h-[450px] bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm relative flex flex-col">
               ...
               <div className="flex-1 overflow-y-auto custom-scrollbar relative z-20 pb-0">
                  ...
                  {/* Hero Section */}
                  <div className="px-8 py-10 flex flex-row items-center min-h-[250px] bg-gray-50/30">
          ...
          {/* ========================================================= */}
          {/* 3. PREVIEW FOOTER & MODAL INFORMASI */}
          {/* ========================================================= */}
          <div>
            <h4 className="text-sm font-bold text-gray-700 mb-3 flex items-center gap-2">
               <span className="w-6 h-6 rounded-md flex items-center justify-center text-white text-xs shadow-sm" style={{backgroundColor: primaryColor}}>3</span>
               Simulasi Footer & Modal Informasi
            </h4>
            
            <div className="space-y-6">
               
               {/* --- A. MOCKUP FOOTER LANDING PAGE --- */}
               ...
               <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 bg-gray-200/50 rounded-2xl border border-gray-200">
                  ...
                  <div className="bg-white rounded-2xl shadow-lg flex flex-col border border-gray-100 overflow-hidden">
                     ...
                     <div className="p-4 flex-1 space-y-2">
                        ...
                        <div className="pl-3 space-y-1.5 py-1">
                           <div className={`h-1.5 w-2/3 bg-gray-300 rounded-full ${blurredText}`}></div>
                           <div className={`h-1.5 w-1/2 bg-gray-300 rounded-full ${blurredText}`}></div>
                        </div>
                     </div>
                  ...
                  <div className="bg-white rounded-2xl shadow-lg flex flex-col border border-gray-100 overflow-hidden">
                     ...
                     <div className="p-4 flex-1">
                        <div className={`h-1.5 w-full bg-gray-200 rounded-full mb-1 ${blurredText}`}></div>
                        <div className={`h-1.5 w-2/3 bg-gray-200 rounded-full mb-4 mx-auto ${blurredText}`}></div>
