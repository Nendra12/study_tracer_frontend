...
export default function GuideSection() {
  const steps = [
    ...
    },
    {
      ...
      icon: Empat,
      accent: "from-primary/20 to-primary/20",
      iconBg: "bg-primary",
    },
  ];
  ...
  return (
    ...
    <section
      id="petunjuk"
      className="py-15 bg-fourth relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mb-20 space-y-4">
          <motion.h2
            ...
            className="text-3xl lg:text-5xl font-black text-primary tracking-tight"
          >
            Petunjuk <span className="text-third">Pendaftaran</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-start text-left">
                ...
                <h3 className="text-xl font-extrabold text-primary mb-4 tracking-tight">
                  {step.title}
                </h3>
